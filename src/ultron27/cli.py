...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--llm-model", default=None, help="Model name for LLM planning")
    parser.add_argument("--llm-endpoint", default=None, help="LLM endpoint for planning")
